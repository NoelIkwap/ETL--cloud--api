...
credentials = service_account.Credentials.from_service_account_file(r'C:\\Users\\aaron.aliu\\repo\\ga_data_api\\env\\key\\servicekey.json')
...
def main(client_id):
	...
	# csv output
	base_df.to_csv(r'C:\Users\aaron.aliu\repo\ga_data_api\env\csv_file\\Ga.csv') #change to desired file path / file name

	#bigquery output
	base_df.to_gbq(
		'analytics.t_googleanalytics_data', #dataset name + table name
		'276918', #project name
		chunksize=10000,
		reauth=False,
		if_exists='replace',
